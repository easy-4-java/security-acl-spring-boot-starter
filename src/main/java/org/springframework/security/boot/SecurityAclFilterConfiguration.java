...
public class SecurityAclFilterConfiguration {
	...
	@Order(104)
	static class AclSecurityFilterChainConfiguration {
		...
		public AclSecurityFilterChainConfiguration(
		...
		@Bean
		@Order(104)
		SecurityFilterChain aclSecurityFilterChain(HttpSecurity http) throws Exception {
